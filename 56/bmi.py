...
def create_parser():
    ...
    # parser.add_argument('help', metavar='-h, --help', help='show this help message and exit')
    # parser.add_argument('weight', metavar='-w WEIGHT, --weight WEIGHT', help='Your weight in kg')
    # parser.add_argument('length', metavar='-l LENGTH, --length LENGTH', help='Your length in cm')
